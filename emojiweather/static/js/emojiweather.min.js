...
EmojiWeather=function($,google){return{emptyForm:function(){var $form=$(".js-search");$form.hasClass("js-search-success")&&$form.find('input[name="q"]').val("")},geolocateAndSubmit:function(){$(".js-geolocate").on("click",function(){var $form=$(".js-search");if("geolocation"in window.navigator&&$form.length){var success=function(pos){var latitude=pos.coords.latitude,longitude=pos.coords.longitude;$q.val(latitude+", "+longitude),$form.trigger("submit")},error=function(err){console.warn(err.code,err.message)},options={enableHighAccuracy:!0,timeout:5e3,maximumAge:0};navigator.geolocation.getCurrentPosition(success,error,options)}})},insertDateTime:function(tz){setInterval(function(){$(".js-moment").text(moment().tz(tz).format("MMMM Do, YYYY, h:mm:ss A"))},1e3)},drawMap:function(selector,latitude,longitude){var minimal=[{elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"administrative",elementType:"geometry",stylers:[{visibility:"off"}]},{featureType:"administrative.land_parcel",stylers:[{visibility:"off"}]},{featureType:"administrative.neighborhood",stylers:[{visibility:"off"}]},{featureType:"poi",stylers:[{visibility:"off"}]},{featureType:"road",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"transit",stylers:[{visibility:"off"}]}],el=$(selector).get(0),options={zoom:10,center:new google.maps.LatLng(latitude,longitude),mapTypeId:"roadmap",styles:minimal,disableDefaultUI:!0};new google.maps.Map(el,options)},init:function(){var self=this;self.emptyForm(),self.geolocateAndSubmit()}}}(jQuery,google),jQuery(function(){"use strict";EmojiWeather.init()});
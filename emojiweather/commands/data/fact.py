RANDOM_FACTS = [
    ...
    'The words "racecar" and "kayak" are spelled the same whether they are read left to right or right to left.',
    ...
    "Only one out of 1,000 people can lick their elbow.",
    ...
    "If you are an average American, in your whole life you will spend an average of six months waiting at a red light."
    ...
    "In the year 210 A.D., a war occurred where an army of 50,000 soldiers defeated an army of 800,000 soldiers.",
    "Ice cream was invented in China, 4,000 years ago.",
